...
const arthur = {
  ...
  coreStack: ["Java", "Go", "Kafka", "Kubernetes", "Azure / AWS / GCP"],
...
![Technologies](https://skillicons.dev/icons?i=java,go,python,ts,kotlin,scala,spring,azure,aws,gcp,kubernetes,docker,terraform,kafka,rabbitmq,mongodb,postgres,redis,prometheus,grafana,githubactions&perline=11&theme=light)
...
### Backend Frameworks
![Micronaut](https://img.shields.io/badge/Micronaut-1A1A1A?style=flat-square)
...
![Debezium](https://img.shields.io/badge/Debezium_CDC-91D443?style=flat-square&logoColor=white)
...
![Grafana](https://img.shields.io/badge/Grafana_·_Loki_·_Tempo_·_Mimir-F46800?style=flat-square&logo=grafana&logoColor=white)
![Prometheus](https://img.shields.io/badge/Prometheus-E6522C?style=flat-square&logo=prometheus&logoColor=white)

### Architecture
`Distributed Systems` · `Microservices` · `Event-Driven Architecture` · `Reactive Systems` · `Domain-Driven Design` · `Idempotency` · `ADRs` · `High Availability` · `Fault Tolerance`
...
<img src="https://substackcdn.com/image/fetch/w_30,h_30,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd9b62b38-c4a1-47dc-8fac-0ec88739efd6_828x828.jpeg" alt="Tech.ish Thoughts" width="20" height="20" />
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge)](https://www.linkedin.com/in/arthur-alves-da-costa)
