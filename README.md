...
<details open>
<summary><b>🚀 FanDuel | Software Engineer</b> <i>(Jun 2023 – Present)</i></summary>

**📍 Porto, Portugal**
- 🏗️ **Infrastructure Modernization**: Migrated workloads from AWS Outposts to Local Zones, achieving **70% cost reduction** across 200+ instances
- ⚡ **Real-time Platform**: Architected serverless platform on AWS handling high-volume, low-latency workloads
- 🛠️ **Automation Tools**: Developed tools in Golang (Cobra, Viper) and Python (Flask, Pydantic, MCP, LLM integrations)
- 📊 **Load Testing**: Designed framework with Locust for multi-region reliability validation
- 🚀 **CI/CD Enhancement**: Improved pipelines with GoCD, GitHub Actions, Jenkins, cutting deployment times by **70%**
- 🔍 **Observability**: Enhanced monitoring with Datadog, Prometheus, Loki, Grafana, CloudWatch
...
**📍 Porto, Portugal**
- 🔄 **System Re-architecture**: Transformed monolithic settlement system to event-driven architecture (Kafka, Debezium, Java, Golang)
- 📈 **Performance Improvement**: Raised processing success rate from **60% to 90%+**
- 🐳 **Containerization**: Built microservices with Kubernetes and Docker, reducing downtime by **20%**
- 📊 **Observability**: Established ELK stack monitoring for enhanced SLA tracking
...
**📍 São Paulo, Brazil**
- ⚡ **High-Performance Services**: Engineered microservices processing **1M+ daily transactions** with **99.99% availability**
- 🎯 **Claim v2 Program**: Led initiative cutting claim resolution times by **30%**, improving customer NPS across LATAM
- 👥 **Mentorship**: Guided junior engineers in Java, Golang, Node.js, and scalable architecture patterns

</details>

<details>
<summary><b>🏦 Itaú Unibanco | Software Engineer</b> <i>(Jul 2019 – Oct 2021)</i></summary>

**📍 São Paulo, Brazil**
- ☁️ **Cloud Migration**: Directed mission-critical core banking systems to Hybrid AWS Cloud (EKS, CodePipeline, CodeBuild)
- 🔒 **Compliance**: Ensured Brazilian Central Bank regulations compliance with **99.9% uptime**
- 📊 **Monitoring Stack**: Implemented Splunk, Grafana, and Prometheus for proactive compliance dashboards
...
⚡ **[Infrastructure Cost Optimization: AWS Local Zones vs Outposts](https://tech-ish-thoughts.com/aws-cost-optimization)**
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/arthur-alves-da-costa)
